    ...
    return(
        <div className={styles.section_bg}>
            <div className={styles.section_title_bg}>
                ...
                <button style={{fontSize:"small", display:"flex", alignItems:"center",height:"100%", borderRadius:20, marginLeft:"50%"}} class="btn btn-secondary" type="button">채피 과목만 보기</button>
